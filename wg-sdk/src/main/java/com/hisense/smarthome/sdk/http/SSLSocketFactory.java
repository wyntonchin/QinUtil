 ...
 * {@link KeyStore truststore} file containg one or several trusted
 ...
 * requested to do so by the server. The target HTTPS server will in its turn
 * verify the certificate presented by the client in order to establish client's
 * authenticity
 * </p>
 * <p>
...
public class SSLSocketFactory implements LayeredSocketFactory {
    ...
    /**
     * The factory using the default JVM settings for secure connections with no
     * certification
     */
    private static SSLSocketFactory IGNORE_CERTIFICATION_FACTORY = null;
    ...
    /**
     * Gets a singleton instance of the SSLProtocolSocketFactory with no
     * certification
     * 
     * @return a SSLProtocolSocketFactory
     */
    public static SSLSocketFactory getIgnoreCertificationSocketFactory() {
        if (IGNORE_CERTIFICATION_FACTORY == null) {
            synchronized (SSLSocketFactory.class) {
                if (IGNORE_CERTIFICATION_FACTORY == null) {
                    try {
                        IGNORE_CERTIFICATION_FACTORY = new SSLSocketFactory(SSL);
        ...
        return IGNORE_CERTIFICATION_FACTORY;
    }
    ...
    /**
     * Creates the default SSL socket factory. This constructor is used
     * exclusively to instantiate the factory for
     * {@link #getIgnoreCertificationSocketFactory
     * getIgnoreCertificationSocketFactory}.
     * 
     * @throws NoSuchAlgorithmException KeyManagementException
     */
    private SSLSocketFactory(String algorithm)
            throws NoSuchAlgorithmException, KeyManagementException {
        super();
        TrustManager[] tm = new TrustManager[] {
                new IgnoreCertificationTrustManager()
        };
        this.sslcontext = SSLContext.getInstance(algorithm);
