...
package com.hisense.smarthome.sdk.network;
...
import com.hisense.smarthome.sdk.network.VolleyLog.MarkerLog;
...
public abstract class Request<T> implements Comparable<Request<T>> {
     ...
     *
     * @deprecated Use
     *             {@link #Request(int, String, com.hisense.smarthome.sdk.network.Response.ErrorListener)}
     *             .
     */
    @Deprecated
     ...
     *         {@link com.hisense.smarthome.sdk.network.Response.ErrorListener}.
     */
    ...
    private byte[] encodeParameters(Map<String, String> params, String paramsEncoding) {
        ...
        try {
            for (Map.Entry<String, String> entry : params.entrySet()) {
                ...
                encodedParams.append(entry.getValue() == null ? ""
