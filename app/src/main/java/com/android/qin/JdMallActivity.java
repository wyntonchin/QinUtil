...
public class JdMallActivity extends BaseToolbarCompatActivity {
    private static final String TAG = "HisenseMallActivity";

    //private static final String HISENSE_MALL_URL = "https://m.hisense.com";

    //private static final String HISENSE_MALL_URL = "https://mall.jd.com/index-754409.html";
    private static final String HISENSE_MALL_URL = "https://shop.m.jd.com/?shopId=754409";
    ...
    private void initWebView() {
        ...
        mWebView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
                LogUtil.w(TAG,"LOLLIPOP request = "+request);
            ...
            public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
                ...
                LogUtil.e(TAG,"description = "+description);
                LogUtil.e(TAG,"failingUrl = "+failingUrl);
            }
