...
public class ToastUtil
{
    ...
    private static void showToast(@StringRes int resId, int duration) {
        showToast(AppUtil.getApp().getResources().getText(resId).toString(), duration);
    }
    ...
    private static void showToast(@StringRes int resId, int duration, Object... args) {
        showToast(String.format(AppUtil.getApp().getResources().getString(resId), args), duration);
    }
    ...
    private static void showToast(CharSequence text, int duration) {
        ...
        if (sToast == null) {
            sToast = Toast.makeText(AppUtil.getApp(), text, duration);
        } else {
            sToast.setText(text);
